...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
            Files associated with user : <?php echo $_GET['id']; ?>	
		...
		<div class="card-body" style="overflow-x:scroll">
			<table class="table tabe-hover table-bordered" id="list" >
				...
				<tbody>
					...
					//display files linked to users department
					$staff_sql .= "SELECT DISTINCT f.id AS file_id
                                    ...
                                    WHERE
										u.id = '" . $_GET['id'] . "'
										OR t.sender_id = '" . $_GET['id'] . "'
                                        OR t.recipient_id = '" . $_GET['id'] . "'
                                        AND f.active = 1";
					...
					<tr style="background-color: <?php echo $rowColor; ?>">
						...
						<td class="text-center">
		                    <div class="btn-group">
		                    	<button type="button" class="btn btn-info btn-flat view_file" data-id="<?php echo $row['file_id'].'&cur_loc='.$row['current_loc'].'&status='.$row['current_status']  ?>" data-toggle="tooltip" title="View Details">
